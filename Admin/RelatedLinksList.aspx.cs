...
public partial class Admin_RelatedLinksList : System.Web.UI.Page
{
    string tablename = "RelatedLinks";
    private string editPage = "RelatedLinksOp.aspx?Op=Edit&id={0}";
    private string addPage = "RelatedLinksOp.aspx?Op=Add";
    ...
    void LoadData()
    {
        ...
        System.Data.DataSet ds = db.ExecuteDataSet("select * from " + tablename +" Order By lang desc");
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        {
            System.IO.File.Delete(Server.MapPath("~/images/RelatedLinks/" + e.CommandName));
        }
    ...
    protected void btnContactDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem rptItem in RepeaterLists.Items)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    System.IO.File.Delete(Server.MapPath("~/Images/RelatedLinks/" + file.Value));
                }
