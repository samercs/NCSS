<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="PressKitList.aspx.cs" Inherits="Admin_NewsList" %>
                ...
                <asp:ListView ID="RepeaterLists" OnPagePropertiesChanged="ListView1_PagePropertiesChanged" ItemPlaceholderID="iph" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <img src="/images/PressKit/<%#Eval("img") %>" width="50"/> 
                            </td>
                            <td>
                                <%#Eval("title") %> 
                            </td>
