...
public partial class Admin_PartnersList : System.Web.UI.Page
{
    string tablename = "Partners";
    private string editPage = "PartnersOp.aspx?Op=Edit&id={0}";
    private string addPage = "PartnersOp.aspx?Op=Add";
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        {
            System.IO.File.Delete(Server.MapPath("~/images/Partners/" + e.CommandName));
        }
    ...
    protected void btnContactDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem rptItem in RepeaterLists.Items)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    System.IO.File.Delete(Server.MapPath("~/Images/Partners/" + file.Value));
                }
