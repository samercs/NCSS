...
public partial class Admin_DBCatList : System.Web.UI.Page
{
    string tablename = "DBCat";
    private string editPage = "DBCatOp.aspx?Op=Edit&id={0}";
    private string addPage = "DBCatOp.aspx?Op=Add";
    public string name = "تصنيفات قواعد البيانات";
    ...
    void LoadData()
    {
        ...
        System.Data.DataSet ds = db.ExecuteDataSet("select * from " + tablename +" Order By title");
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        {
            System.IO.File.Delete(Server.MapPath("~/images/DBCat/" + e.CommandName));
        }
    ...
    protected void btnContactDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem rptItem in RepeaterLists.Items)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    System.IO.File.Delete(Server.MapPath("~/Images/DBCat/" + file.Value));
                }
