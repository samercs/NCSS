...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="PollOp.aspx.cs" Inherits="Admin_PollOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="تاريخ التصويت" CssClass="label_xblack"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtAddDate" ValidationGroup="Option3" CssClass="txt1" runat="server"></asp:TextBox>
                    </td>
                    <td></td>
                </tr>
               <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" Text="عرض في الصفحة الرئيسية" CssClass="label_xblack"></asp:Label></td>
                    <td>
                        <asp:CheckBox ID="cbShowInHome"  runat="server" />
                    </td>
                    <td></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <a href="PollList.aspx" class="btnLogin2 fr">الغاء</a>
