<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="DBCatList.aspx.cs" Inherits="Admin_DBCatList" %>
                ...
                <asp:ListView ID="RepeaterLists" OnPagePropertiesChanged="ListView1_PagePropertiesChanged" ItemPlaceholderID="iph" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <img src="/images/DBCat/<%#Eval("img") %>" width="50"/> 
                            </td>
                            <td>
