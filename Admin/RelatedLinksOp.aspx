...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="RelatedLinksOp.aspx.cs" Inherits="Admin_RelatedLinksOp" %>
        ...
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="العنوان" CssClass="label_xblack"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <a href="AlbumsList.aspx" class="btnLogin2 fr">الغاء</a>
