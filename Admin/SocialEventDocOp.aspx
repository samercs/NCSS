<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="SocialEventDocOp.aspx.cs" Inherits="Admin_ResearchOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td colspan="2">
                        <a href="SocialEventList.aspx" class="btnLogin2 fr">الغاء</a>
