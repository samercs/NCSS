...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="DBCatOp.aspx.cs" Inherits="Admin_DBCatOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="العنوان عربي" CssClass="label_xblack"></asp:Label></td>
                    <td>
