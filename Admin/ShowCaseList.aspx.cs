...
public partial class Admin_ShowCaseList : System.Web.UI.Page
{
    ...
    void LoadData()
    {
        ...
        System.Data.DataSet ds = db.ExecuteDataSet("select * from " + tablename + " order by ShowOrder" + ";" + "");
    ...
    {
        Response.Redirect("ShowcaseOp.aspx?id=" + e.CommandArgument + "&Op=Edit");
    }
