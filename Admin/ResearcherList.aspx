<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ResearcherList.aspx.cs" Inherits="Admin_ResearcherList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:HyperLink ID="HyperLink3" NavigateUrl="" CssClass="tdn fr" runat="server"><h5><i class="fa fa-plus-square-o"></i> اضافة باحث جديد</h5></asp:HyperLink>
            <asp:LinkButton ID="btnContactDelete" OnClick="btnContactDelete_Click" runat="server" CssClass="tdn fr mr10px btnDelete"><h5><i class="fa fa-times"></i> حذف الباحثين المختارين</h5></asp:LinkButton>
            <div class="clear"></div>
                ...
                <asp:ListView OnItemDataBound="RepeaterLists_OnItemDataBound" ID="RepeaterLists" OnPagePropertiesChanged="ListView1_PagePropertiesChanged" ItemPlaceholderID="iph" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td  id="imgTd" runat="server">
                                <img src="/images/Researchers/<%#Eval("img") %>" width="50"/>
                                <asp:HiddenField ID="isAproved" runat="server" Value='<%# Eval("isAproved") %>' />
                            </td>
                            <td>
                                <%#Eval("name") %> 
                            </td>
                            ...
                            <td>
                                <asp:LinkButton CommandName='<%#Eval("img") %>' CssClass="btnDelete" ID="btnDelete" OnCommand="btnDelete_Command"  CommandArgument='<%#Eval("id") %>' runat="server"><i class="fa fa-trash fs20px"></i> حذف</asp:LinkButton>
                                ...
                                <a href="ResearchList.aspx?id=<%#Eval("id") %>"><i class="fa fa-book"></i> الابحاث </a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:ListView>
