<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="ResearchOp.aspx.cs" Inherits="Admin_ResearchOp" %>
        ...
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="الباحث" CssClass="label_xblack"></asp:Label></td>
                    <td>
                        <asp:DropDownList ID="ddlResearcher" CssClass="ddl1" runat="server">
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <uc1:hijriCalender ValidationGroup="Option3" Class="txtCal" runat="server" ID="txtPublishDate" />
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <uc1:hijriCalender ValidationGroup="Option3" Class="txtCal" runat="server" ID="txtAddDate" />
                    </td>
                    <td></td>
                </tr>
