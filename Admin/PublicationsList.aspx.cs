...
public partial class Admin_PublicationsList : System.Web.UI.Page
{
    string tablename = "Publications";
    private string editPage = "PublicationsOp.aspx?Op=Edit&id={0}";
    private string addPage = "PublicationsOp.aspx?Op=Add";
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        {
            System.IO.File.Delete(Server.MapPath("~/images/Publications/" + e.CommandName));
        }
    ...
    protected void btnContactDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem rptItem in RepeaterLists.Items)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    System.IO.File.Delete(Server.MapPath("~/Images/Publications/" + file.Value));
                }
