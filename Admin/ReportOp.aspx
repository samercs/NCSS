...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="ReportOp.aspx.cs" Inherits="Admin_ReportOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td colspan="2">
                        <a href="ReportList.aspx" class="btnLogin2 fr">الغاء</a>
