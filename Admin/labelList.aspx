<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="labelList.aspx.cs" Inherits="Admin_labelList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:LinkButton OnClick="LinkButton1_OnClick" ID="LinkButton1" CssClass="tdn fr mr10px" runat="server"><h5><i class="fa fa-refresh"></i> اعادة تحميل</h5></asp:LinkButton>
            <div class="clear"></div>
                ...
                <asp:ListView ID="RepeaterLists" OnPagePropertiesChanged="ListView1_PagePropertiesChanged" ItemPlaceholderID="iph" runat="server">
                    <LayoutTemplate>
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="Pager AC">
                                    <asp:DataPager ID="DataPager2" PagedControlID="RepeaterLists" PageSize="20" runat="server">
                                        <Fields>
                                            <asp:NumericPagerField CurrentPageLabelCssClass="CurrentPageNumber" ButtonCount="100" />
                                        </Fields>
                                    </asp:DataPager>
                                </div>
                            </td>
