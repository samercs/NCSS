<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="RelatedLinksList.aspx.cs" Inherits="Admin_RelatedLinksList" %>
                ...
                <asp:ListView ID="RepeaterLists" OnPagePropertiesChanged="ListView1_PagePropertiesChanged" ItemPlaceholderID="iph" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <img src="/images/RelatedLinks/<%#Eval("img") %>" width="50"/> 
                            </td>
                            <td>
                                <%#Eval("title") %> 
                            </td>
