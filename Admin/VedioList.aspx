<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="VedioList.aspx.cs" Inherits="Admin_VedioList" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                             ...
                             <td>
                                 <a target="_new" href="https://www.youtube.com/watch?v=<%#Eval("url") %>">https://www.youtube.com/watch?v=<%#Eval("url") %> </a> 
                            </td>
                            <td>
