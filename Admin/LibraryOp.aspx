<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="LibraryOp.aspx.cs" Inherits="Admin_ExpertiseOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="المؤلف" CssClass="label_xblack"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label14" runat="server" Text="التصنيف" CssClass="label_xblack"></asp:Label></td>
                    <td>
