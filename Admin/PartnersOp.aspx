...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="PartnersOp.aspx.cs" Inherits="Admin_PartnersOp" %>
        ...
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="ترتيب العرض" CssClass="label_xblack"></asp:Label></td>
                    <td>
