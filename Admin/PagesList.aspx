<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="PagesList.aspx.cs" Inherits="Admin_PagesList" %>
                ...
                <asp:ListView ID="RepeaterLists" OnPagePropertiesChanged="ListView1_PagePropertiesChanged" ItemPlaceholderID="iph" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%--<asp:LinkButton ID="btnDelete" OnCommand="btnDelete_Command" CommandArgument='<%#Eval("id") %>' runat="server"><i class="fa fa-trash fs20px"></i> Delete</asp:LinkButton>--%>
