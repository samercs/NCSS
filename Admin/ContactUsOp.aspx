...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="ContactUsOp.aspx.cs" Inherits="Admin_ContactUsOp" %>
        ...
        <asp:Panel ID="Panel1"  runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" Text="رقم الهاتف" CssClass="label_xblack"></asp:Label></td>
                    <td>
                        <asp:Label ID="lblPhone" CssClass="Bold" runat="server" Text=""></asp:Label>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="الدولة" CssClass="label_xblack"></asp:Label></td>
                    <td>
                        <asp:Label ID="lblCountry" CssClass="Bold" runat="server" Text=""></asp:Label>
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <a href="ContactUsList.aspx" class="btnLogin2 fr">رجوع</a>
