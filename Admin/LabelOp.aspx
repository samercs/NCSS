...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="LabelOp.aspx.cs" Inherits="Admin_LabelOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Text="الرمز" CssClass="label_xblack"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtKey" ValidationGroup="Option3" CssClass="txt1" runat="server"></asp:TextBox>
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <a href="labelList.aspx" class="btnLogin2 fr">الغاء</a>
