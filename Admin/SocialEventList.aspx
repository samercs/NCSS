<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="SocialEventList.aspx.cs" Inherits="Admin_SocialEventList" %>
                ...
                <asp:ListView ID="RepeaterLists" OnPagePropertiesChanged="ListView1_PagePropertiesChanged" ItemPlaceholderID="iph" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <img src="/images/SocialEvent/<%#Eval("img") %>" width="50"/> 
                            </td>
                            <td>
                                <%#Eval("title") %> 
                            </td>
