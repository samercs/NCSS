...
public partial class Admin_NewsList : System.Web.UI.Page
{
    ...
    private string editPage = "PressKitOp.aspx?Op=Edit&id={0}";
    private string addPage = "PressKitOp.aspx?Op=Add";
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        {
            System.IO.File.Delete(Server.MapPath("~/images/PressKit/" + e.CommandName));
        }
    ...
    protected void btnContactDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem rptItem in RepeaterLists.Items)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    System.IO.File.Delete(Server.MapPath("~/Images/PressKit/" + file.Value));
                }
