<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="SocialEventOp.aspx.cs" Inherits="Admin_SocialEventListOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Text="التفاصيل" CssClass="label_xblack"></asp:Label></td>
                    <td>
