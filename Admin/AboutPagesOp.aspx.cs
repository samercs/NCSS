...
public partial class Admin_AboutPagesOp : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                db.AddParameter("@pageKey", DateTime.Now.Ticks.ToString());
                long pageId = db.ExecuteNonQuery_id("insert into pages (title,txt,prev,lang,pageKey) values (@title,@Text,@Prv,@lang,@pageKey)");
                db.AddParameter("pageId", pageId);
                db.AddParameter("ImageId", DBNull.Value);
