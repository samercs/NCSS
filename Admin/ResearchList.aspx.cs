...
public partial class Admin_ResearchList : System.Web.UI.Page
{
    ...
    private string editPage = "ResearchOp.aspx?Op=Edit&id={0}";
    private string addPage = "ResearchOp.aspx?Op=Add";
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        {
            System.IO.File.Delete(Server.MapPath("~/images/Research/"+ e.CommandName));
        }
    ...
    protected void btnContactDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem rptItem in RepeaterLists.Items)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    System.IO.File.Delete(Server.MapPath("~/Images/Research/" + file.Value));
                }
