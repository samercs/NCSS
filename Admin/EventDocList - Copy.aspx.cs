...
public partial class Admin_EventDocList : System.Web.UI.Page
{
    string tablename = "EventDoc";
    private string editPage = "EventDocOp.aspx?Op=Edit&id={0}";
    private string addPage = "EventDocOp.aspx?Op=Add";
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        {
            System.IO.File.Delete(Server.MapPath("~/images/EventDoc/" + e.CommandName));
        }
    ...
    protected void btnContactDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem rptItem in RepeaterLists.Items)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    System.IO.File.Delete(Server.MapPath("~/Images/EventDoc/" + file.Value));
                }
