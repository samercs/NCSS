...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="SpecializedDBOp.aspx.cs" Inherits="Admin_SpecializedDBOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label8" runat="server" Text="الوصف" CssClass="label_xblack"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="التصنيف" CssClass="label_xblack"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <a href="PartnersList.aspx" class="btnLogin2 fr">الغاء</a>
