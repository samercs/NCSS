<%@ Page Title="" Theme="En" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NewsDetails.aspx.cs" Inherits="NewsDetails" %>
        ...
        <div class="fr">
            ...
            <asp:Repeater ID="Repeater3" runat="server">
                <ItemTemplate>
                    ...
                    <img class="img-responsive PhoDatailsImg" src="/images/News/<%#Eval("img") %>" />
                    <%#Eval("txt") %>
...
<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://ncss.gov.sa/NewsDetails.aspx?id=<%#Eval("id") %>" data-text="الاخبار  | المركز الوطني للدراسات والبحوث الاجتماعية" data-dnt="true">Tweet</a>
...
<div class="fb-share-button" data-href="http://ncss.gov.sa/NewsDetails.aspx?id=<%#Eval("id") %>" data-layout="button_count"></div>
</div>
<!-- زر مشاركة  الليكند ان لصفحة الاخبار -->
<div   class="sharfloat">
<script src="//platform.linkedin.com/in.js" type="text/javascript">    lang: en_US</script>
<script type="IN/Share" data-url="http://ncss.gov.sa/NewsDetails.aspx?id=<%#Eval("id") %>" data-counter="right"></script>
</div>
                </ItemTemplate>
            </asp:Repeater>
