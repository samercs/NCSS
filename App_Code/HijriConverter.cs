...
/// <summary>
/// Summary description for HijriConverter
/// </summary>
public class Dates
{
    ...
    public string Convert_From_Hijri_To_Gregorian(string date)
    {
        CultureInfo arCI = new CultureInfo("ar-SA");
        DateTime tempDate = DateTime.ParseExact(date, "d/M/yyyy", arCI.DateTimeFormat, DateTimeStyles.AllowInnerWhite);
