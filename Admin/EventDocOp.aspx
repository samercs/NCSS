<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="EventDocOp.aspx.cs" Inherits="Admin_EventDocOp" %>
    ...
    <section>
        <asp:Panel ID="Panel1" DefaultButton="btnSave" runat="server">
            <table class="tblConListOpt">
                ...
                <tr>
                    <td colspan="2">
                        <a href="EventDocList.aspx?id=<%=Request.QueryString["pid"] %>" class="btnLogin2 fr">الغاء</a>
