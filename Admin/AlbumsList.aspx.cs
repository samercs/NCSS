...
public partial class Admin_AlbumsList : System.Web.UI.Page
{
    string tablename = "Albums";
    private string editPage = "AlbumsOp.aspx?Op=Edit&id={0}";
    private string addPage = "AlbumsOp.aspx?Op=Add";
    public string name = "البوم الصور";
    ...
    void LoadData()
    {
        ...
        System.Data.DataSet ds = db.ExecuteDataSet("select * from " + tablename +" Order By lang,ShowOrder desc");
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        {
            System.IO.File.Delete(Server.MapPath("~/images/Albums/" + e.CommandName));
        }
    ...
    protected void btnContactDelete_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem rptItem in RepeaterLists.Items)
        {
            ...
            if (chk.Checked)
            {
                ...
                {
                    System.IO.File.Delete(Server.MapPath("~/Images/Albums/" + file.Value));
                }
