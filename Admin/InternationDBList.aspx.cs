...
public partial class Admin_InternationalDB : System.Web.UI.Page
{
    string tablename = "InternationalDB";
    private string editPage = "InternationalDBOp.aspx?Op=Edit&id={0}";
    private string addPage = "InternationalDBOp.aspx?Op=Add";
