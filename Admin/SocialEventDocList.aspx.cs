...
public partial class Admin_SocialEventList : System.Web.UI.Page
{
    string tablename = "SocialEventDoc";
    private string editPage = "SocialEventDocOp.aspx?Op=Edit&id={0}&pid={1}";
    private string addPage = "SocialEventDocOp.aspx?Op=Add&pid=";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            HyperLink3.NavigateUrl = addPage+Request.QueryString["id"];
            LoadData();
        }
    }
    void LoadData()
    {
        ...
        System.Data.DataSet ds = db.ExecuteDataSet("select * from " + tablename );
    ...
    protected void btnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        Database db = new Database();
        string  sql = "delete from " + tablename + " where id =" + e.CommandArgument;
    ...
    {
        Response.Redirect(String.Format(editPage,e.CommandArgument.ToString(),Request.QueryString["id"]));
    }
