<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="LibraryList.aspx.cs" Inherits="Admin_ExpertiseList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:HyperLink ID="HyperLink3" NavigateUrl="" CssClass="tdn fr" runat="server"><h5><i class="fa fa-plus-square-o"></i> اضافة بحث الى المكتبة</h5></asp:HyperLink>
            <asp:LinkButton ID="btnContactDelete" OnClick="btnContactDelete_Click" runat="server" CssClass="tdn fr mr10px btnDelete"><h5><i class="fa fa-times"></i> حذف الابحاث المختارة</h5></asp:LinkButton>
            <div class="clear"></div>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                ...
                                <asp:HiddenField ID="file" runat="server" Value='<%# Eval("file") %>' />
